create function public.close_party(p_host_id uuid,p_party_id uuid,p_command_id uuid,p_expected_revision bigint)
...
begin
    ...
    update public.picture_caption_rounds set state='completed',phase=null,captioning_deadline=null,captioning_hard_deadline=null,paused_remaining_seconds=null,voting_deadline=null,voting_paused_remaining_seconds=null where game_session_id=session_record.id and state='active';
