-- Lower the Caption submission length ceiling from 120 to 75 characters, per playtest feedback.
update public.picture_caption_rounds set caption_grapheme_limit=75 where caption_grapheme_limit>75;
alter table public.picture_caption_rounds drop constraint picture_caption_rounds_caption_grapheme_limit_check;
alter table public.picture_caption_rounds add constraint picture_caption_rounds_caption_grapheme_limit_check check (caption_grapheme_limit between 1 and 75);
alter table public.picture_caption_rounds alter column caption_grapheme_limit set default 75;
