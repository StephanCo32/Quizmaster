...
insert into tap_results select lives_ok($$select * from public.remove_picture_caption_submission('11111111-bbbb-4111-8111-111111111111', (select id from public.parties limit 1), (select id from public.picture_caption_submissions limit 1), 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 6)$$, 'Host can remove a caption during Captioning');
