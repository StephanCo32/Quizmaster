...
insert into tap_results select plan(19);
...
insert into tap_results select lives_ok($$select * from public.create_picture_caption_template('33333333-3333-4333-8333-333333333333', 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 'Sunset', 'https://example.com/sunset.jpg', 'Write another caption')$$, 'duplicate names and URLs are accepted');
...
insert into tap_results select throws_ok($$select * from public.create_picture_caption_template('33333333-3333-4333-8333-333333333333', 'dddddddd-dddd-4ddd-8ddd-dddddddddddd', '', 'https://example.com/invalid.jpg', 'Write a caption')$$, '23514', null, 'invalid names are rejected');
insert into tap_results select throws_ok($$select * from public.create_picture_caption_template('33333333-3333-4333-8333-333333333333', '99999999-9999-4999-8999-999999999999', 'Missing caption', 'https://example.com/missing.jpg', null)$$, '22023', 'official_caption_required', 'an empty official caption is rejected on create');
