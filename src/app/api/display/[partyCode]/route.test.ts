...
const { getDisplayParty, getDisplayPartyCanonicalCode, getDisplayPartyLobby, getDisplaySessionId } = vi.hoisted(() => ({
...
vi.mock("@/lib/display/sessions", () => ({ getDisplayParty, getDisplayPartyCanonicalCode, getDisplayPartyLobby, getDisplaySessionId }));
