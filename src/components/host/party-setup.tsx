      ...
      <div className="dashboard-grid">
        <section className="dashboard-stage setup-stage">
          ...
          <div className="broadcast-panel setup-panel">
            ...
            {party.game_session_state === "live" && !rounds.some((round) => round.state === "active") && <div className="round-lifecycle-actions"><button className="broadcast-action" type="button" disabled={busy || !canWrite} onClick={() => void lifecycleCommand({ action: "finish" })}>Finish Game session</button></div>}
