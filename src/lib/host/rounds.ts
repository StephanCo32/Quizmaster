...
import type { HostPictureCaptionBallot, HostPictureCaptionRevealCandidate, HostPictureCaptionTemplate, LobbyCommandResult, PictureCaptionCompletion, PictureCaptionRound, PictureCaptionSubmission } from "@/lib/supabase/database.types";
